...
<c:forEach items="${payload2list}" var="entry">
                 [ '${entry.hourName}', ${entry.d1} , ${entry.d2} , ${entry.d3} , ${entry.d4} , ${entry.d5} , ${entry.d6} , ${entry.d7} , ${entry.d8} , ${entry.d9} , ${entry.d10} , ${entry.d11} , ${entry.d12} , ${entry.d13} , ${entry.d14} , ${entry.d15} , ${entry.d16} , ${entry.d17} , ${entry.d18} , ${entry.d19} , ${entry.d20} , ${entry.d21} , ${entry.d22}, ${entry.d23} , ${entry.d24} , ${entry.d25} , ${entry.d26} , ${entry.d27} , ${entry.d28} , ${entry.d29} , ${entry.d30}, ${entry.d31} ],
              </c:forEach> 
            ...
            // Set chart options
            var options = {'title' : payloadType + ' analysis report of '+fd,
               hAxis: {
                  title: 'Hour'
               },
               vAxis: {
