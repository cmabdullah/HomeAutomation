...
public class Payload implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(payload.getD1(), getD1()) == 0 &&
                Double.compare(payload.getD2(), getD2()) == 0 &&
                Double.compare(payload.getD3(), getD3()) == 0 &&
                Double.compare(payload.getD4(), getD4()) == 0 &&
                Double.compare(payload.getD5(), getD5()) == 0 &&
                Double.compare(payload.getD6(), getD6()) == 0 &&
                Double.compare(payload.getD7(), getD7()) == 0 &&
                Double.compare(payload.getD8(), getD8()) == 0 &&
                Double.compare(payload.getD9(), getD9()) == 0 &&
                Double.compare(payload.getD10(), getD10()) == 0 &&
                Double.compare(payload.getD11(), getD11()) == 0 &&
                Double.compare(payload.getD12(), getD12()) == 0 &&
                Double.compare(payload.getD13(), getD13()) == 0 &&
                Double.compare(payload.getD14(), getD14()) == 0 &&
                Double.compare(payload.getD15(), getD15()) == 0 &&
                Double.compare(payload.getD16(), getD16()) == 0 &&
                Double.compare(payload.getD17(), getD17()) == 0 &&
                Double.compare(payload.getD18(), getD18()) == 0 &&
                Double.compare(payload.getD19(), getD19()) == 0 &&
                Double.compare(payload.getD20(), getD20()) == 0 &&
                Double.compare(payload.getD21(), getD21()) == 0 &&
                Double.compare(payload.getD22(), getD22()) == 0 &&
                Double.compare(payload.getD23(), getD23()) == 0 &&
                Double.compare(payload.getD24(), getD24()) == 0 &&
                Double.compare(payload.getD25(), getD25()) == 0 &&
                Double.compare(payload.getD26(), getD26()) == 0 &&
                Double.compare(payload.getD27(), getD27()) == 0 &&
                Double.compare(payload.getD28(), getD28()) == 0 &&
                Double.compare(payload.getD29(), getD29()) == 0 &&
                Double.compare(payload.getD30(), getD30()) == 0 &&
                Double.compare(payload.getD31(), getD31()) == 0 &&
                getId().equals(payload.getId()) &&
                getHourName().equals(payload.getHourName()) &&
                getMonthlyData().equals(payload.getMonthlyData()) &&
                getWeatherEntity().equals(payload.getWeatherEntity());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getHourName(), getD1(), getD2(), getD3(), getD4(), getD5(), getD6(), getD7(), getD8(), getD9(), getD10(), getD11(), getD12(), getD13(), getD14(), getD15(), getD16(), getD17(), getD18(), getD19(), getD20(), getD21(), getD22(), getD23(), getD24(), getD25(), getD26(), getD27(), getD28(), getD29(), getD30(), getD31(), getMonthlyData(), getWeatherEntity());
    }
}
